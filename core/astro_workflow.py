# core/astro_workflow.py
# =============================================================================
# گردش‌کار کامل آسترولوژی (Astrology Workflow)
# -----------------------------------------------------------------------------
# این فایل هیچ handler تلگرامی ندارد.
# فقط یک سرویس است که:
#   1) داده‌های کاربر را از state دریافت می‌کند
#   2) چارت تولد را محاسبه می‌کند
#   3) تفسیر فارسی تولید می‌کند
#   4) چارت تصویری را رسم می‌کند
#   5) خروجی را برای کاربر ارسال می‌کند
#   6) state را ریست می‌کند
# =============================================================================
